...
// The row sub class.
#pragma link C++ class CP::TTPC_Wire_Geometry_Table+;
...
// is also needed.
#pragma link C++ class CP::TDbiResultSetHandle<CP::TTPC_Wire_Geometry_Table>+;

// The direct class set handle dictionary.  This must be declared after the
// TDbiResultSetHandle.
#pragma link C++ class CP::TResultSetHandle<CP::TTPC_Wire_Geometry_Table>+;
